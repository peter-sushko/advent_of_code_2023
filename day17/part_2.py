'''
For solving advent of code puzzles day 17 part 2.
...
Conveniently, the code from part 1 requires very little modification to 
adapt for part 2.
'''
...
def solve_maze(min_step :int, max_step :int, cnt = 0):
    ...
    while nodes_to_check:
        ...
        # Now, time for a trick: iterate over all possible step sizes.
        # This means every new move is a turn.
        for step in 1j/direction, -1j/direction: # Always good time for complex algebra.
            for step_length in range(min_step, max_step + 1): # Now this is an input.
